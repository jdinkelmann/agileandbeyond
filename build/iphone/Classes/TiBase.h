...
// in simulator we redefine to format for agileandbeyond Developer console
...
{\
	NSString * exceptionName = [@"org.agileandbeyond." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.agileandbeyond";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIagileandbeyondNativeItemNone = -1, 
	UIagileandbeyondNativeItemSpinner = -2,
	UIagileandbeyondNativeItemProgressBar = -3,
	
	UIagileandbeyondNativeItemSlider = -4,
	UIagileandbeyondNativeItemSwitch = -5,
	UIagileandbeyondNativeItemMultiButton = -6,
	UIagileandbeyondNativeItemSegmented = -7,
	
	UIagileandbeyondNativeItemTextView = -8,
	UIagileandbeyondNativeItemTextField = -9,
	UIagileandbeyondNativeItemSearchBar = -10,
	
	UIagileandbeyondNativeItemPicker = -11,
	UIagileandbeyondNativeItemDatePicker = -12,
	
	UIagileandbeyondNativeItemInfoLight = -13,
	UIagileandbeyondNativeItemInfoDark = -14,
	
	UIagileandbeyondNativeItemDisclosure = -15,
	
	UIagileandbeyondNativeItemContactAdd = -16
};
