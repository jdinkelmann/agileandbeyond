...
//@interface agileandbeyondObject : NSObject
//@end

@interface agileandbeyondObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[agileandbeyondObject class]])
		{
			for (NSString *key in [[(agileandbeyondObject*)o modules] allKeys])
			{
